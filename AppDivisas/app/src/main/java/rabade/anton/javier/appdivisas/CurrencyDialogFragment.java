...
public class CurrencyDialogFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        builder.setTitle("Actual currency € to $: "+ dH.getCurrency())
        .setView(v)
        .setPositiveButton("Cambiar", new DialogInterface.OnClickListener(){
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                try {
                    ...
                    db.execSQL("UPDATE "+DatabaseHelper.TABLE_NAME+" SET "+DatabaseHelper.COLUMN_TABLE_CURRENCY+"="+newValor+" WHERE "+
                            DatabaseHelper.COLUMN_TABLE_COMMISSION+"='"+dH.getCommission() + "'");
                }catch (Exception e){}
                //Aceptar
            }
